/**
 * ======================================================
 * CHART OF ACCOUNTS & EVENT CONSTANTS
 * ======================================================
 * Adapted for the current backend-inter architecture.
 * Commission is calculated ONLY on productTotal (not delivery).
 */
...
export const ACCOUNT_CODES = Object.freeze({
  ...
  MARKETPLACE_COMMISSION_REVENUE: "4020",
  SALES_RETURNS: "4900",
  COGS: "5001",
...
export const DEFAULT_CHART_OF_ACCOUNTS = Object.freeze([
  ...
  { code: "1015", name: "PayHere Gateway Balance", type: ACCOUNT_TYPES.ASSET, normalBalance: ENTRY_SIDES.DEBIT },
  ...
  { code: "2010", name: "Seller Payable", type: ACCOUNT_TYPES.LIABILITY, normalBalance: ENTRY_SIDES.CREDIT },
  { code: "2100", name: "VAT / GST Payable", type: ACCOUNT_TYPES.LIABILITY, normalBalance: ENTRY_SIDES.CREDIT },
  { code: "2300", name: "Unearned Revenue (Prepayments)", type: ACCOUNT_TYPES.LIABILITY, normalBalance: ENTRY_SIDES.CREDIT },
  ...
  { code: "4020", name: "Marketplace Commission Revenue", type: ACCOUNT_TYPES.REVENUE, normalBalance: ENTRY_SIDES.CREDIT },
